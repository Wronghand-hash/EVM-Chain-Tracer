...
//     );
//     console.log(
//       `Block: ${receipt.blockNumber} | Value: ${ethers.utils.formatEther(
//         transaction.value
//       )} BNB`
//     );
...
//       const iface = new ethers.utils.Interface(uniswapUniversalAbi);
...
//     try {
//       const routerIface = new ethers.utils.Interface(pancakeRouterAbi);
...
//             ) {
//               console.log(
//                 `Mint detected: ${ethers.utils.formatUnits(
//                   transfer.value,
//                   18
...
//         ethers.utils.formatUnits(finalAmountIn, inputInfo.decimals)
//       );
//       const amountOutDecimal = parseFloat(
//         ethers.utils.formatUnits(finalAmountOut, outputInfo.decimals)
//       );
//       console.log(
